...
description: Payflink erlaubt es Ihnen jederzeit innerhalb Minuten das Angebot auf Ihrer Speisekarte selber anzupassen. So können Sie Speisen und Getränke erfassen, anpassen oder auch entfernen. Wie dies im Detail geht, erfahren Sie hier.
layout: '@layouts/Documentation.astro'
---

import Figure from '@components/Figure.astro'

In Payflink stehen Ihnen zwei Möglichkeiten zur Verfügung, um Ihre Speisekarte anzupassen. Sie können in jedem Fall die Artikel in unserem CMS (Content Management System) bearbeiten. Falls Payflink mit Ihrer Kasse verbunden ist, können wir die Artikel auch direkt importieren.

## Artikel im CMS bearbeiten

Loggen Sie sich mit Ihrem persönlichen Benutzernamen und Passwort auf dem Payflink-CMS ein. Dort sehen Sie vier Hauptbereiche.
...
In Payflink haben Sie immer eine Speisekarte, auch wenn unter "Menu cards" nicht erfasst ist. Möchten Sie zeit- oder ortsabhängig Ihr Angebot oder die Preise anpassen, so müssen Sie unter "Menu cards" weitere Speisekarten erfassen. Nachdem Sie eine Speisekarte erfasst haben, können Sie Artikel oder Kategorien dieser Speisekarte zuweisen und Ihr Angebot so steuern.
...
<Figure
  ...
  caption="Mit Payflink haben Sie eine grosse Auswahl an Einstellungsmöglichkeiten."
  size="article"
/>
...
Ist Payflink mit Ihrer Kasse verbunden, so können Sie die Artikel der Kasse direkt importieren. Dies geschieht automatisch mit jeder Änderung an der Kasse. Nachdem Sie eine Änderung an der Kasse vorgenommen haben, dauert es in der Regel 10 min bis die Änderungen in der Speisekarte erscheinen.
